#include "opengl_reflection_refraction.h"
...
void Render()
{
	...
	for (int i = 0; i < TMO_MAX; ++i)
	{
		...
		shader_program.setUniform("materialInfo.Eta", 0.9f);
		shader_program.setUniform("materialInfo.ReflectFactor", 0.5f);
...
void PrepareShader()
{
	const char* vert_shader_name = "res_learn_opengl/shaders/reflection_and_refraction_vert.glsl";
	const char* frag_shader_name = "res_learn_opengl/shaders/reflection_and_refraction_frag.glsl";
