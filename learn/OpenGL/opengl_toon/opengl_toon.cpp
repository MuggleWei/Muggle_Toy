...
void Update()
{
	...
	mat_model[TMO_Sphere] = muggle::MathUtils::Translate(muggle::vec3f(3.0f, 0.0f, -3.0f));
	mat_model[TMO_Torus] = muggle::MathUtils::Translate(muggle::vec3f(-3.0f, 0.0f, -3.0f));
}
void Render()
{
	// enable depth test
	...
	muggle::vec4f light_position_in_eye = mat_view.Multiply(muggle::vec4f(2.0f, 2.0f, -5.0f, 1.0f));
...
void PrepareData()
{
	...
	// p_mesh[TMO_Torus] = muggle::Mesh::Load("res/Stanford 3D Scanning/bunny/reconstruction/bun_zipper.ply");
...
void PrepareShader()
{
	const char* vert_shader_name = "res_learn_opengl/shaders/Toon_vert.glsl";
	const char* frag_shader_name = "res_learn_opengl/shaders/Toon_frag.glsl";
