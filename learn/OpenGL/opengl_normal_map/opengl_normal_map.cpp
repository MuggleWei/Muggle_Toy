...
static muggle::Texture* p_tex_normal = nullptr;
...
{
	// load texture
	static const char* diffuse_image_path = "res/textures/brick_d.png";
	static const char* normal_image_path = "res/textures/brick_n.png";
	p_tex_diffuse = muggle::Texture::Load(diffuse_image_path);
	p_tex_normal = muggle::Texture::Load(normal_image_path);
	MWARNING(p_tex_diffuse != nullptr, "Failed load texture in %s\n", diffuse_image_path);
	MWARNING(p_tex_normal != nullptr, "Failed load texture in %s\n", normal_image_path);
...
void PrepareShader()
{
	const char* vert_shader_name = "res_learn_opengl/shaders/normal_map_vert.glsl";
	const char* frag_shader_name = "res_learn_opengl/shaders/normal_map_frag.glsl";
	...
	shade_model[GTSM_Diffuse] = glGetSubroutineIndex(shader_program.getHandle(), GL_FRAGMENT_SHADER, "diffuseModel");
	shade_model[GTSM_DiffuseAndNormal] = glGetSubroutineIndex(shader_program.getHandle(), GL_FRAGMENT_SHADER, "diffuseNormalModel");
...
void CreateVAO()
{
	...
	glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE,
		p_mesh->vertex_decl.stride, (void*)p_mesh->vertex_decl.offsets[muggle::VertexAttribute::Tangent]);
	glVertexAttribPointer(4, 3, GL_FLOAT, GL_FALSE,
		p_mesh->vertex_decl.stride, (void*)p_mesh->vertex_decl.offsets[muggle::VertexAttribute::Bitangent]);
